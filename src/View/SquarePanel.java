...
public class SquarePanel extends JPanel {
	...
	private Border thickBorder = BorderFactory.createLineBorder(Colors.GREEN.getColor(),8);
	...
	protected void paintComponent(Graphics g){
		...
		if(square.isKing() && square.getIsFilled()){
			...
			g2.drawString("King", getWidth()/2-14, getHeight()/2+8);
		}
	}
	...
	private void paintAdditional(Graphics2D g3){
		int padding= 22;
		g3.fillOval(padding/2, padding/2, getWidth()-padding, getHeight()-padding);
	}
	/**
	 * My Mouse Listener 
	 */
